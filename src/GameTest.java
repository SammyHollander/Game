...
public class GameTest extends JComponent {
    ...
    public class monsterAtrib {
        ...
        public monsterAtrib(int x0,int y0,int w,int h,int speedX,int speedY){
             ...
             this.maSpeedX=speedX;
             this.maSpeedY=speedY;
        }
    }
    ...
    List<GameTest.monsterAtrib> mobs = new ArrayList<monsterAtrib>();
   ...
   // Rectangle monster = new Rectangle(WIDTH / 2, HEIGHT / 2, 15, 15);
    ...
    public void GameTest() {
        ...
        for(int i = 0; i < 10; i++){
           monsterAtrib mon= new monsterAtrib(WIDTH/2,HEIGHT/2,15,15,3+i,3+i);
            mobs.add(mon);
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        //draw the monsters
        g.fillRect(mobs.maPos.get(0));
        //as the score increases, more monsters will be drawn
        if (Score > 2) {
            //set monster color to pink (because I can)
            g.setColor(Color.pink);
            g.fillRect(monster.x, monster1.y, monster1.width, monster1.height);
        }
        if (Score > 3) {
            //set monster color to pink (because I can)
